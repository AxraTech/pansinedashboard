...
const ProductCategoryEdit = () => {
    ...
    const [updateCategoryByPk] = useMutation(UPDATE_CATEGORY_BY_PK, { refetchQueries: [ { query: CATEGORY_BY_PK , variables: { id } }, { query: PRODUCT_CATEGORY_ALL } ]})
    ...
    const updateHandler = async () => {
        ...
        if(Object.keys(newErrors).length === 0){
            try{
                ...
                let formData = { ...data };
                if(data.image_url !== category.product_categories_by_pk.image_url) {
