...
const ProductLists = () => {
    ...
    return (
        <div className="w-full h-full overflow-hidden  px-2 md:px-8">
            <Header category="Product" title="List"/>

            <Table tableHeader={tableHeader} >
                {
                    productLists ?
                        productLists.products.length > 0 ?
                            ...
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row" colSpan={tableHeader.length} className="text-center px-6 py-4 font-medium text-gray-900 dark:text-white">
                                    No Data
                                </th>
                            </tr>
                        :
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" colSpan={tableHeader.length} className="text-center px-6 py-4 font-medium text-gray-900 dark:text-white">
                                <div role="status" className="inline-block mr-4">
