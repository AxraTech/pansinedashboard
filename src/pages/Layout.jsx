...
const Layout = () => {
    ...
    return (
        <div className=" h-screen grid grid-cols-12 overflow-hidden">
            ...
            <div className={activeMenu ? 'col-span-12 w-full min-h-screen flex-2' : 'col-span-12 w-full min-h-screen flex-2'}>
                <div className="h-full w-full grid grid-rows-12">
                    {/*Start Nav Bar*/}
                    <NavBar activeMenu={activeMenu} setActiveMenu={setActiveMenu}/>
                    {/*End Nav Bar*/}

                    <div className={`row-span-11 overflow-y-auto py-5 ${activeMenu && 'ml-[288px]'}`}>
